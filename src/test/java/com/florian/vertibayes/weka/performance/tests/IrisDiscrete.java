...
import static com.florian.vertibayes.notunittests.generatedata.GenerateNetworks.buildIrisNetworkDiscrete;
...
public class IrisDiscrete {

    public static final String TEST_FULL = "resources/Experiments/IrisDiscrete/irisWeka.arff";
    public static final String TEST_FULL_MISSING = "resources/Experiments/IrisDiscrete/irisMissing.arff";

    public static final String FIRSTHALF = "resources/Experiments/IrisDiscrete/iris_firsthalf.csv";
    public static final String SECONDHALF = "resources/Experiments/IrisDiscrete/iris_secondhalf.csv";

    public static final String FOLD_LEFTHALF = "resources/Experiments/IrisDiscrete/folds/irisLeftSplit";
    public static final String FOLD_RIGHTHALF = "resources/Experiments/IrisDiscrete/folds/irisRightSplit";

    public static final String FOLD_LEFTHALF_MISSING = "resources/Experiments/IrisDiscrete/folds/irismissingLeftSplit";
    public static final String FOLD_RIGHTHALF_MISSING = "resources/Experiments/IrisDiscrete/folds" +
            "/irismissingRightSplit";

    public static final String FIRSTHALF_MISSING = "resources/Experiments/IrisDiscrete/irisMissingLeft.csv";
    public static final String SECONDHALF_MISSING = "resources/Experiments/IrisDiscrete/irisMissingRight.csv";

    public static final String TEST_FOLD = "resources/Experiments/IrisDiscrete/folds/iris";

    public static final String IRIS_WEKA_BIF = "resources/Experiments/IrisDiscrete/irisWekaBif.xml";

    private static final String LABEL = "label";
    private static final String NAME = "IrisDiscrete";

    private static List<WebNode> NODES = buildIrisNetworkDiscrete();
    ...
    private static void initNodes() {
        NODES = buildIrisNetworkDiscrete();
    }

    public static Performance kFoldUnknown(double treshold) throws Exception {
        initNodes();
        List<WebNode> nodes = buildIrisNetworkDiscrete();
        ...
        p.setName(NAME);
        Performance irisUnknown = IrisDiscrete.weka(treshold);
    ...
    public static Performance kFold() throws Exception {
        ...
        p.setName(NAME);
        Performance iris = IrisDiscrete.weka();
