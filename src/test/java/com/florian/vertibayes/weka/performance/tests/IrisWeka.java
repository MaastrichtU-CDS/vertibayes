...
import static com.florian.vertibayes.notunittests.generatedata.GenerateNetworks.buildIrisNetworkWekaBinned;
...
public class IrisWeka {
    ...
    private static void initNodes() {
        NODES = buildIrisNetworkWekaBinned();
    }
    ...
    public static Performance kFoldUnknown(double treshold) throws Exception {
        ...
        p.setName(NAME);
        Performance irisUnknown = IrisWeka.weka(treshold);
    ...
    public static Performance kFold() throws Exception {
        ...
        p.setName(NAME);
        Performance iris = IrisWeka.weka();
