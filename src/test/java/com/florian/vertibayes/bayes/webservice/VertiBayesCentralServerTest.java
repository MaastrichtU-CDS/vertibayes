...
public class VertiBayesCentralServerTest {
    ...
    public void testExpectationMaximizationhoodBinned() throws Exception {
        ...
        // value 1 key: -1;0.5 which corresponds to the range of the first bin
        assertEquals(map.get("-inf").getP(), 0.5, 0.05);
        ...
        //keys: <child range>p<parent range>
        assertEquals(map.get("-inf-inf").getP(), 0.8, 0.05);
        ...
        assertEquals(map.get("inf-inf").getP(), 0.2, 0.05);
        ...
        assertEquals(map.get("-infinf").getP(), 0.2, 0.05);
        ...
        assertEquals(map.get("infinf").getP(), 0.8, 0.05);
        ...
        assertEquals(map.get("0-inf").getP(), 0.8, 0.05);
        ...
        assertEquals(map.get("1-inf").getP(), 0.2, 0.05);
