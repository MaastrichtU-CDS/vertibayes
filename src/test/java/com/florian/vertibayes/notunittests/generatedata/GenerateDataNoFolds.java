...
public class GenerateDataNoFolds {
    ...
    public void generateAllData() throws Exception {
        ...
        generateData(buildIrisNetworkBinned(), CSV_PATH_IRIS, FIRSTHALF_IRIS, SECONDHALF_IRIS, 150);
...
//        generateData(buildAsiaNetwork(), CSV_PATH_ASIA_MISSING, FIRSTHALF_ASIA_MISSING, SECONDHALF_ASIA_MISSING,
//        10000);
...
//                     10000);
    ...
    private void generateData(List<WebNode> input, String output, String firsthalf, String secondhalf, int samplesize)
        ...
        generateData(output, samplesize, nodes);
    }

    private void generateData(String output, int samplesize, List<Node> nodes) {
                        ...
                        if (node.getParents().size() == 0) {
                            ...
                            if (x <= y) {
                                ...
                                if (!local.isRange()) {
                                    ...
                                    individual.put(node.getName(), String.valueOf(round(generated)));
                                }
                                break;
                            }
                        } else {
